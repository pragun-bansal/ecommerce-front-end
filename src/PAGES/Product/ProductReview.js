            ...
            <div className="flex flex-col justify-start items-start w-full space-y-8 ">
                ...
                <div className="w-full flex justify-start items-start flex-col bg-gray-50 p-8 ">
                    ...
                    {Reviews.map((item)=>{
                        ...
                        {/* className={"md:block " + (menu1 ? "block" : "hidden")} */}
                        <div className={"md:block " + (menu ? "block" : "hidden")}>
                            <p className="mt-3 text-base leading-normal text-gray-600 w-full md:w-9/12 xl:w-5/6">{item.review}</p>
                            
                            <div className="mt-6 flex justify-start items-center flex-row space-x-2.5">
                                <div>
                                    <img src={item.avatar} alt="girl-avatar" className="w-[50px]"/>
                                </div>
                                <div className="flex flex-col justify-start items-start space-y-2">
                                    <p className="text-base font-medium leading-none text-gray-800">{item.name}</p>
                                    <p className="text-sm leading-none text-gray-600">{item.date}</p>
                                </div>
                            </div>
                        </div>
                    </div>
