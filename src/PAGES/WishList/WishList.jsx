...
const WishList = () => {
    const wishlistStateRedux = useSelector((state) => state.WishList);
    // console.log(wishlistStateRedux)
  ...
  <Controls visible={false} buttons={['play', 'repeat', 'frame', 'debug']} />
        ...
        <div className="mx-auto container px-4 md:px-6 2xl:px-0 py-12 flex justify-center items-center">
            <div className="flex flex-col jusitfy-start items-start">
                ...
                <div className="mt-4">
                    <p className="text-2xl tracking-tight leading-6 text-gray-600">{wishlistStateRedux.items.length} {wishlistStateRedux.items.length==1?"item":"items"}</p>
                </div>
                <div className=" mt-10 lg:mt-12 grid grid-cols-1 lg:grid-cols-3 gap-x-8 gap-y-10 lg:gap-y-0">
                    {
                        wishlistStateRedux.items.length?wishlistStateRedux.items.map((product,index)=>{
                            return (
                        ...
                        <div className="mt-6 flex justify-between items-center">
                            <div className="flex justify-center items-center">
                                <p className="tracking-tight text-2xl font-semibold leading-6 text-gray-800">{product.productId.name}</p>
                            </div>
                            <div className="flex justify-center items-center">
                                <button aria-label="show menu" onClick={() => setshow1(!show1)} className="hidden focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-800 py-2.5 px-2 bg-gray-800 text-white hover:text-gray-400">
                        ...
                        <div id="menu1" className={` flex-col jusitfy-start items-start mt-12 ${show1 ? "flex mb-4" : "hidden"}`}>
                            <div>
                                <p className="tracking-tight text-xs leading-3 text-gray-800">{product.productId.tagline}</p>
                            </div>
                            <div className="mt-2">
                            ...
                            <div className="mt-6">
                                <p className="tracking-tight text-base font-medium leading-4 text-gray-800">₹{product.productId.price}</p>
                            </div>
                            <div className="flex jusitfy-between flex-col lg:flex-row items-center mt-10 w-full  space-y-4 lg:space-y-0 lg:space-x-4 xl:space-x-8">
                                ...
                                <Link to={`/products/${product.productId._id}`} className="block text-center focus:outline-none focus:ring-gray-800 focus:ring-offset-2 focus:ring-2 text-gray-800 w-full tracking-tight py-4 text-lg leading-4 hover:bg-gray-300 hover:text-gray-800  bg-white border border-gray-800">More information</Link>
                                </div>
                                <div className="w-full">
                                    <button onClick={() => { handleAddToCart(product) }} className="focus:outline-none focus:ring-gray-800 focus:ring-offset-2 focus:ring-2  text-white w-full tracking-tight py-4 text-lg leading-4  hover:bg-black bg-gray-800 border border-gray-800">Add to Cart</button>
                    ...
                    {/* <div className="flex flex-col">
                        ...
                        <div id="menu2" className={`flex-col jusitfy-start items-start mt-12 ${show2 ? "flex" : "hidden"}`}>
                            ...
                            <div className="flex jusitfy-between flex-col lg:flex-row items-center mt-10 w-full space-y-4 lg:space-y-0 lg:space-x-4 xl:space-x-8">
                                <div className="w-full">
                                    <Link to={`/products/product`} className=" focus:outline-none focus:ring-gray-800 focus:ring-offset-2 focus:ring-2 text-gray-800 w-full tracking-tight py-4 text-lg leading-4 hover:bg-gray-300 hover:text-gray-800  bg-white border border-gray-800">More information</Link>
                                </div>
                                <div className="w-full">
