...
import testimonialJSON from "./testimonialJSON";
    ...
    <div className="mt-[10vh]">
        ...
        <div className="container mx-auto" >
            <div className="flex items-center justify-center w-full h-full py-12 md:py-24 sm:py-8 px-4">
                ...
                <CarouselProvider className="lg:block hidden " naturalSlideWidth={100} isIntrinsicHeight={true} totalSlides={testimonialJSON.length+2} visibleSlides={3} step={1} infinite={true} interval={3000} isPlaying={true} dragEnabled={true}>
                    <div className="w-full relative flex items-center justify-center">
                        ...
                        <div className="w-full h-full mx-auto overflow-x-hidden overflow-y-hidden">
                            <Slider>
                                ...
                                {
            testimonialJSON.map((testi,index)=>{
                return(
                    <Slide index={index}>
                                    <div>
                        ...
                        <div className="group w-full bg-white relative flex flex-col items-center hover:bg-indigo-700 cursor-pointer shadow-md md:p-12 p-6">
                            <div className="text-gray-600 group-hover:text-white flex flex-col items-center">
                                ...
                                <p className="xl:w-80 text-base leading-normal text-center mt-4">{testi.comment}</p>
                            </div>
                        ...
                        <div className="flex flex-col items-center justify-center mt-10">
                            ...
                            <p className="text-base font-semibold leading-4 my-2 text-gray-800">{testi.name}</p>
                            <p className="text-base leading-4 text-center text-gray-600">{testi.post}</p>
                        </div>
                    </div>
                                    </Slide>
                )
                        ...
                        <div className="flex flex-col items-center justify-center mt-10">
                            ...
                            <p className="text-base leading-4 text-center text-gray-600">Developer</p>
                                    ...
                                    <Slide index={testimonialJSON.length+1}>
                ...
                <CarouselProvider className="lg:hidden md:block hidden" naturalSlideWidth={100} isIntrinsicHeight={true} totalSlides={testimonialJSON.length} visibleSlides={2} step={1} infinite={true} interval={3000} isPlaying={true} touchEnabled={true}>
                    <div className="w-full relative flex items-center justify-center">
                        <ButtonBack role="button" aria-label="slide backward" className="absolute z-30 left-0 ml-8 focus:outline-none focus:bg-gray-400 focus:ring-2 focus:ring-offset-2 focus:ring-gray-400 cursor-pointer" id="prev">
                            <svg width={8} height={14} viewBox="0 0 8 14" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path d="M7 1L1 7L7 13" stroke="white" strokeWidth={2} strokeLinecap="round" strokeLinejoin="round" />
                        ...
                        <div className="flex flex-col items-center justify-center mt-10">
                            ...
                            <p className="text-base leading-4 text-center text-gray-600">{testi.post}</p>
                                    ...
                                    <Slide index={testimonialJSON.length}>
                                        <div className="flex flex-shrink-0 relative w-full sm:w-auto">
                                            <img src="https://i.ibb.co/rFsGfr5/carosel-4.png" alt="sitting area" className="object-cover object-center w-full" />
                                            <div className="bg-gray-800 bg-opacity-30 absolute w-full h-full p-6">
                                                <h2 className="lg:text-xl leading-4 text-base lg:leading-5 text-white">Catalog 2</h2>
                ...
                <CarouselProvider className="block md:hidden " naturalSlideWidth={100} isIntrinsicHeight={true} totalSlides={testimonialJSON.length+1} visibleSlides={1} step={1} infinite={true} interval={3000} isPlaying={true} touchEnabled={true}>
                    <div className="w-full relative flex items-center justify-center">
                        <ButtonBack role="button" aria-label="slide backward" className="absolute z-30 left-0 ml-8 focus:outline-none focus:bg-gray-400 focus:ring-2 focus:ring-offset-2 focus:ring-gray-400 cursor-pointer" id="prev">
                            <svg width={8} height={14} viewBox="0 0 8 14" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path d="M7 1L1 7L7 13" stroke="white" strokeWidth={2} strokeLinecap="round" strokeLinejoin="round" />
