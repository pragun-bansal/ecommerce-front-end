...
import { Sidebar, SidebarBody, SidebarLink } from "../../Components/ui/acertinityUI/sidebar";
import {
    IconArrowLeft,
    IconBrandTabler,
    IconSettings,
...
export function SidebarDemo({menu}) {

    const links = [
        {
            label: "Users",
            href: "/admin/menu/user",
            icon: (
...
export const LogoIcon = () => {
    return (
        (<Link
            href="#"
            className="font-normal flex space-x-2 items-center text-sm text-black py-1 relative z-5">
            <div
                className="h-5 w-6 bg-black dark:bg-white rounded-br-lg rounded-tr-sm rounded-tl-lg rounded-bl-sm flex-shrink-0" />
        </Link>)
    );
