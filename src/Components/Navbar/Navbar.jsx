      ...
      <div className='flex h-[12vh]  lg:h-[17vh]  content-center justify-center align-middle'>
        ...
        {token ?
            <div className="mb-4 lg:mb-0 mr-1 lg:translate-y-[11vh]   2xl:translate-y-[11.3vh] p-2">
              ...
              <button href="#dest" onMouseOver={() => {
                ...
                setDropdown2(false)
                      ...
                      className={dropdown2 || droppeddown2 ? `text-white` : `text-white`}>
                <img className="h-[2.5vh] w-[2.5vh]  md:w-10 md:h-10 rounded-full cursor-pointer" src={user.pfp}
                     alt="pfp"/>
                <span
                    className={dropdown || droppeddown2 ? `block max-w-full transition-all duration-500 h-0.5 bg-white` : `max-w-0 block transition-all duration-500 h-0.5 bg-white`}></span>
              </button>
              <div onMouseOver={() => {
                setDroppeddown2(true)
              }} onMouseOut={() => {
                setDroppeddown2(false)
              }} id="dropdownNavbar"
                   className={dropdown2 || droppeddown2 ? `absolute translate-x-[-10px] translate-y-[-10px] bg-white z-10 font-normal  divide-y divide-gray-100  shadow-md w-44 ` : `hidden`}>
                <ul className="py-2 text-sm text-gray-700 " aria-labelledby="dropdownLargeButton">
                  <li>
                    <Link to="/profile" class="block px-4 py-2 hover:bg-gray-100 text-center">View Profile</Link>
                  </li>
                  <li>
                    <button onClick={() => handleLogOut()} className="block px-4 py-2 hover:bg-gray-100 w-full">Logout
                      User
                    </button>
                  </li>
                </ul>
            ...
            <button onClick={() => {
              ...
              <svg className="h-[4vh] lg:h-[6vh] lg:translate-y-[5.5vh] translate-y-[-4vh] p-2 "
        ...
        <button onClick={() => {
          ...
          <svg className="fill-[#EE6983]  h-[4vh] lg:h-[6vh]  lg:translate-y-[5.5vh] translate-y-[-4vh] p-2 "
